...
@section('content')
        ...
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <div class="md:ml-24">
                ...
                <div class="flex flex-wrap items-center text-gray-400 text-sm mt-4">
                    ...
                    <span
                        class="ml-2">{{ app()->getLocale() === 'ru' ? $actor['birthday'] : $actor['birthday'] }} ({{ app()->getLocale() === 'ru' ? $actor['age'] : $actor['age'] }} years old) in {{ app()->getLocale() === 'ru' ? $actor['place_of_birth'] : $actor['place_of_birth'] }}
                    </span>
                </div>
                ...
                <h4 class="font-semibold mt-12">{{ app()->getLocale() === 'ru' ? 'Известность за' : 'Known For' }}</h4>
    ...
    <div class="credits border-b border-gray-800">
        <div class="container mx-auto px-4 py-16">
            <h2 class="text-4xl font-semibold">{{ app()->getLocale() === 'ru' ? 'Кредиты' : 'Credits' }}</h2>
